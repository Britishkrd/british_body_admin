...
import 'sendingalerts.dart';

class BatchAlertSending extends StatefulWidget {
  final String adminemail;
  const BatchAlertSending({super.key, required this.adminemail});

  @override
  State<BatchAlertSending> createState() => _BatchAlertSendingState();
}

class _BatchAlertSendingState extends State<BatchAlertSending> {
  List<String> selectedUsers = [];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ناردنی ئاگاداری بە کۆمەڵ'),
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Material1.button(
                label: 'زیادکردنی ئاگاداری',
                buttoncolor: Material1.primaryColor,
                textcolor: Colors.white,
                function: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return Sendingalerts(
                        adminemail: widget.adminemail, emails: selectedUsers);
                  }));
                }),
          ),
        ],

...
class Adminaddinrulestosubdept extends StatefulWidget {
  final DocumentReference<Map<String, dynamic>> department;
  final String subdepartment;
  final String email;
  const Adminaddinrulestosubdept(
      {super.key,
  ...
  @override
  State<Adminaddinrulestosubdept> createState() =>
      _AdminaddinrulestosubdeptState();
}

typedef _Fn = void Function();

class _AdminaddinrulestosubdeptState extends State<Adminaddinrulestosubdept> {
...
// ----------------------------- UI --------------------------------------------
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('زیادکردنی یاساکان بۆ بەشی لاوەکی'),
          ...
          Container(
              ...
              child: Material1.button(
                  ...
                  function: () async {
                    ...
                    widget.department
                        .collection('rules')
                        .doc(widget.subdepartment)
                        .collection(widget.subdepartment)
                        .doc(
                            "${widget.subdepartment}${ruletitlecontroller.text}")
                        .set({

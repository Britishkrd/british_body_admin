...
import 'package:british_body_admin/screens/dashborad.dart/salary/receivingsalary/receivingsalary.dart';
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                              "${(snapshot.data!.docs[index].data() as Map<String, dynamic>).containsKey('isreceived') ? (snapshot.data!.docs[index]['isreceived'] == false ? 'وەرنەگیراوە' : 'وەرگیراوە') : 'وەرنەگیراوە'} ",
                                              style: TextStyle(
                                                  fontSize: 16.sp,
                                                  fontWeight: FontWeight.bold)),
                                          Text(": موچەکە",

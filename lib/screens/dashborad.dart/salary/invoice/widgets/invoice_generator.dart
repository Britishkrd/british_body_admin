...
class InvoiceGenerator {
  ...
  num _calculatePunishment(
      int workTarget, Duration totalWorkedTime, int punishmentPerHour) {
...
pw.Widget buildCompleteDetailsSection({
  ...
  final missedHours = workTarget - totalWorkedTime.inHours;
  final punishmentForMissedWork =
      missedHours > 0 ? missedHours * punishmentPerHour : 0;
    ...
    child: pw.Table(
      ...
      children: [
        ...
        buildTableRow(
            ...
            value:
                '${totalWorkedTime.inHours} کاتژمێر و ${totalWorkedTime.inMinutes.remainder(60)} خولەک',
            theme: theme,
            ttfFont: ttfFont),
        ...
        buildTableRow(
            ...
            value:
                '$workTarget کاتژمێر (${(workTarget / 8).toStringAsFixed(0)} ڕۆژ)',
            theme: theme,
            ttfFont: ttfFont),
        ...
        buildTableRow(
            ...
            value: '${formatNumber(loan == '' ? 0 : double.parse(loan))} دینار',
            theme: theme,
            ttfFont: ttfFont),
        ...
        pw.TableRow(
          ...
          children: [
            pw.Container(
              padding:
                  const pw.EdgeInsets.symmetric(vertical: 12, horizontal: 12),
              child: pw.Text(
...
pw.Widget buildThankYouSection(
  ...
  return pw.Column(
    ...
    children: [
      ...
      pw.SizedBox(height: 16),
      pw.Text(
        'سوپاس بۆ بەردەوام بوونت لە British Body',
        style: pw.TextStyle(
          font: ttfFont,
          fontSize: theme.bodyFontSize,
          color: theme.secondaryColor,
